...
macro import_options()
  :(
    using BVPInterface: OptionsODE, getOption, setOption!, setOptions!,
                        copyOptions!
  )
end
...
"""
  ...
  In this BVPInterface this parameters are called 'options' and
